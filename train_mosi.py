...
from model_performer_multihead import LMF
from utils import total, load_mosi_3d_
...
def main(options):
    ...
    train_set, valid_set, test_set, input_dims, input_lens = load_mosi_3d_(data_path)
    ...
    for row in f[1:]:
        ...
        for r2 in params['rank2']:
        
            current_setting = (ahid, vhid, thid, adr, vdr, tdr, factor_lr, lr, r, r2, batch_sz, decay)
            ...
            model = LMF(input_dims, input_lens, (ahid, vhid, thid), thid_2, (adr, vdr, tdr, 0.5), output_dim, r, r2)
            ...
            valid_iterator = DataLoader(test_set, batch_size=len(test_set), num_workers=4, shuffle=True)
...
if __name__ == "__main__":
    ...
    OPTIONS.add_argument('--run_id', dest='run_id', type=int, default=2021)
    ...
    OPTIONS.add_argument('--signiture', dest='signiture', type=str, default='mosi_man')     
